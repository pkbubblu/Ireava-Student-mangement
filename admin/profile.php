      ...
      <nav class="teal">
        <div class="container">
          <div class="nav-wrapper">
            <a href="" class="brand-logo center">Ireava</a>
                                        ...
                                        <div class="row">
                                                <div class="card-action">
                                                    <div class="col s4 m4 l4">
                                                        <div class="input-field ">
                                                            <a href="#" class="btn orange hoverable btn-floating pulse"><i class="material-icons">thumb_up</i></a> &nbsp; &nbsp; 
                                                            <a href="#" class="btn orange hoverable btn-floating"><i class="material-icons">thumb_down</i></a>
                                                        </div>
                                                    </div>
